...
def init_args():
    ...
    parser.add_argument(
        ...
        # "--rec_char_dict_path", type=str, default="/gpfs/projects/CascanteBonillaGroup/paola/PaddleOCR/ppocr/utils/ppocr_keys_v1.txt"
    )
    ...
    parser.add_argument(
        ...
        # "--e2e_char_dict_path", type=str, default="/gpfs/projects/CascanteBonillaGroup/paola/PaddleOCR/ppocr/utils/ic15_dict.txt"
    )
